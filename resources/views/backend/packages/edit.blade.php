...
<div class="page-header">
  <h4 class="page-title">{{ __('Package Edit') }}</h4>
  <ul class="breadcrumbs">
    ...
    <li class="nav-item">
      <a href="#">{{ __('Packages Edit') }} <span class="text-danger">[{{ $language->name }}]</span> </a>
    </li>
  </ul>
</div>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-lg-4">
            <div class="card-title d-inline-block">{{ __('Package Edit') }}</div>
          </div>
          <div class="col-lg-8">
            <div class="float-right">

              <a href="{{ route('admin.package',['language'=> $defaultLang->code]) }}" class="btn btn-primary btn-sm">
                Back</a>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-12">
            <form id="ajaxEditForm" action="{{ route('admin.package.update_package') }}" method="POST">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="days" value="{{ $package->days }}">
                <p id="editErr_days" class="mt-2 mb-0 text-danger em"></p>
              </div>
              <div class="form-group">
                <label for="">{{ __('Percentage') . '(%)' . '*' }}</label>
                <input type="number" class="form-control" name="percentage" value="{{ $package->percentage }}">
                <p id="editErr_percentage" class="mt-2 mb-0 text-danger em"></p>
              </div>
              <div class="form-group">
