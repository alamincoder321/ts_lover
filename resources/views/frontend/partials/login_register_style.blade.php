<link rel="stylesheet" type="text/css" href="{{ asset('/assets/login_registration/css/all.min.css') }}">
<link rel="stylesheet" href="{{ asset('/assets/login_registration/css/bootstrap.min.css') }}">
<link href="{{ asset('/assets/login_registration/css/login-new.css') }}" rel="stylesheet">
