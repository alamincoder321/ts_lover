...
<div class="body">
  <header id="header" class="header-effect-shrink header-transparent"
    ...
    <div class="header-body header-body-bottom-border border-top-0 appear-animation" data-appear-animation="fadeIn"
            ...
            <div class="header-row">
              <div class="header-logo">
                <a href="demo-startup-agency.html">
                  <img src="img/demos/startup-agency/logo.png" class="img-fluid" width="123" height="32" alt="" />
                </a>
              </div>
            </div>
          </div>
                ...
                <div
                  ...
                  <nav class="collapse">
                    <ul class="nav nav-pills" id="mainNav">
                      <li><a href="#home" class="nav-link active" data-hash data-hash-offset="0"
                          data-hash-offset-lg="70">Home</a></li>
                      <li><a href="#aboutus" class="nav-link" data-hash data-hash-offset="0"
                          data-hash-offset-lg="255">About</a></li>
                      <li><a href="#team" class="nav-link" data-hash data-hash-offset="0"
                          data-hash-offset-lg="35">Team</a></li>
                      <li><a href="#works" class="nav-link" data-hash data-hash-offset="0"
                          data-hash-offset-lg="120">Works</a></li>
                      ...
                      <li><a href="https://cyplfx.com/user/login" class="nav-link" data-hash data-hash-offset="0"
                          data-hash-offset-lg="135">Login</a></li>
                      <li><a href="https://cyplfx.com/user/signup" class="nav-link" data-hash data-hash-offset="0"
                          data-hash-offset-lg="70">Register</a></li>
                    </ul>
                  </nav>
                </div>
              </div>
    ...
    <section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
      ...
      <div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
        <div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn"
          ...
          style="background-image: url(image/morphing-bg-1.jpg); background-size: cover; background-position: center;">
        </div>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 2000 935" xml:space="preserve" data-appear-animation-svg="true"
        ...
        <div class="container mt-5 pt-5">
          <div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
            <div class="col-lg-6">
              <h1 class="font-weight-bold text-12 mb-2 appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="1200">We Are Digital Experts</h1>
              <h2 class="font-weight-medium text-9 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="1400">Based in Los Angeles / CA
              </h2>
              <p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation"
                data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">Lorem ipsum dolor sit
                amet, consectetur adipis.</p>
              <a href="#" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation"
                data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800">Get Started</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="aboutus" class="row align-items-center pt-4 pb-lg-5 my-5" data-spy-offset="15">
        <div class="col-lg-6 pb-sm-5 pb-lg-0 mb-5 mb-lg-0">
          <div class="custom-svg-wrapper-1 px-5">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
              y="0px" viewBox="0 0 687 673" data-plugin-float-element-svg="true">
            ...
            <div data-plugin-float-element
              ...
              <img src="img/demos/startup-agency/about-us-1.png"
                class="img-fluid position-relative z-index-1 appear-animation" data-appear-animation="fadeInUpShorter"
        ...
        <div class="col-lg-6">
          ...
          <p class="custom-font-secondary custom-font-size-1 line-height-6 mb-4 pb-2 pe-lg-5 appear-animation"
            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Lorem ipsum dolor sit amet,
            consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur.</p>
          <p class="custom-font-size-2 font-weight-light pb-2 mb-4 appear-animation"
            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Vestibulum auctor felis eget
            orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In
            nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
    ...
    <div class="container mt-4 mb-5">
      <div id="pricing" class="row justify-content-center">
        <div class="col-lg-10 text-center">
          <span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block appear-animation"
          ...
          <h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
            data-appear-animation-delay="400">Best Price Guarantee</h2>
          <p class="custom-font-size-2 font-weight-light mb-4 pb-3 appear-animation"
            data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Vestibulum auctor felis eget
            orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In
            nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
        </div>
      </div>
        ...
        <div class="row justify-content-center pt-5">
          <div class="col-lg-10 text-center">
            <span
              ...
              data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">OUR TEAM</span>
            <h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
              data-appear-animation-delay="400">We Are Passionate</h2>
            <p class="custom-font-size-2 font-weight-light appear-animation" data-appear-animation="fadeInUpShorter"
              data-appear-animation-delay="600">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque
              ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac,
              finibus vitae dui.</p>
          </div>
        </div>
        <div class="row mb-5 mb-lg-0">
          <div class="col">
            <div class="custom-svg-wrapper-2">
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                y="0px" viewBox="0 0 1736 315" data-plugin-float-element-svg="true">
                <g data-plugin-float-element
                  data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
                        ...
                        <div class="card-body p-3">
                          <div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
                            <div class="thumb-info-wrapper">
                              <img src="img/demos/startup-agency/authors/author-1.jpg" class="img-fluid"
                                alt="John Doe" />
                            </div>
                          </div>
                          <h3
                    ...
                    <a href="#" class="text-decoration-none">
                      <div class="card custom-card-style-1 box-shadow-4 my-3">
                        <div class="card-body p-3">
                          <div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
                            <div class="thumb-info-wrapper">
                              <img src="img/demos/startup-agency/authors/author-2.jpg" class="img-fluid"
                                alt="John Doe" />
                            </div>
                          </div>
                          <h3
                    ...
                    <a href="#" class="text-decoration-none">
                      <div class="card custom-card-style-1 box-shadow-4 my-3">
                        <div class="card-body p-3">
                          <div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
                            <div class="thumb-info-wrapper">
                              <img src="img/demos/startup-agency/authors/author-3.jpg" class="img-fluid"
                                alt="John Doe" />
                            </div>
                          </div>
                          <h3
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-10 text-center">
            ...
            <p class="custom-font-size-2 font-weight-light text-color-light mb-4 pb-3">Vestibulum auctor felis eget
              orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In
              nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
          </div>
        </div>
                ...
                <a href="#">
                  <div
                    ...
                    <div class="thumb-info-wrapper rounded-0">
                      <img src="img/demos/startup-agency/works/work-1.jpg" class="img-fluid rounded-0" alt="Work 1" />
                    </div>
                  </div>
                </a>
              </div>
              <div class="my-5">
                <a href="#">
                  <div
                    class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                    <div class="thumb-info-wrapper rounded-0">
                      <img src="img/demos/startup-agency/works/work-2.jpg" class="img-fluid rounded-0" alt="Work 2" />
                    </div>
                  </div>
                </a>
              </div>
              <div class="my-5">
                <a href="#">
                  <div
                    class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                    <div class="thumb-info-wrapper rounded-0">
                      <img src="img/demos/startup-agency/works/work-3.jpg" class="img-fluid rounded-0" alt="Work 3" />
                    </div>
                  </div>
                </a>
              </div>
              <div class="my-5">
                <a href="#">
                  <div
                    class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                    <div class="thumb-info-wrapper rounded-0">
                      <img src="img/demos/startup-agency/works/work-4.jpg" class="img-fluid rounded-0" alt="Work 4" />
                    </div>
                  </div>
                </a>
              </div>
              <div class="my-5">
                <a href="#">
                  <div
                    class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
                    <div class="thumb-info-wrapper rounded-0">
                      <img src="img/demos/startup-agency/works/work-5.jpg" class="img-fluid rounded-0" alt="Work 5" />
                    </div>
                  </div>
                </a>
              </div>
  ...
  <footer id="footer" class="border-0 bg-dark pt-4 mt-0" data-spy-offset="15">
    <div class="custom-svg-wrapper-4 pb-5">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 1667 581" data-plugin-float-element-svg="true">
        <g data-plugin-float-element
          data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
      ...
      <div class="container mt-5 mt-lg-0">
        <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="row pb-5 mb-5">
                  <div class="col">
                    <div data-plugin-float-element
                      data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
                      <img class="icon-animated" width="55" src="img/demos/startup-agency/icons/icon-location.svg"
                        alt="" data-icon
                      ...
                      <p class="text-4 text-color-light opacity-5 font-weight-light mb-0">123 Street Name, City,
                        England</p>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                    <div data-plugin-float-element
                      ...
                      <img class="icon-animated" width="55" src="img/demos/startup-agency/icons/icon-mail.svg" alt=""
                        data-icon
                      ...
                      <a href="mailto:email@domain.com"
                        class="text-4 text-color-light text-color-hover-primary opacity-5 font-weight-light mb-0">porto@portotheme.com</a>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-6 pt-5">
                ...
                <div class="row pb-5 mb-5">
                  <div class="col">
                    <div data-plugin-float-element
                      data-plugin-options="{'startPos': 'bottom', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
                      <img class="icon-animated" width="55" src="img/demos/startup-agency/icons/icon-phone.svg" alt=""
                        data-icon
                        data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-secondary mb-3'}" />
                      <h4 class="font-weight-bold text-color-light text-5 mb-0">Phone Number</h4>
                      <a href="tel:+1234567890"
                        class="text-4 text-color-light text-color-hover-primary opacity-5 font-weight-light mb-0">(800)
                        123-4567</a>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                    <div data-plugin-float-element
                      data-plugin-options="{'startPos': 'bottom', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
                      <img class="icon-animated" width="55" src="img/demos/startup-agency/icons/icon-calendar.svg"
                        alt="" data-icon
                        data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
                      <h4 class="font-weight-bold text-color-light text-5 mb-0">Working Days/Hours</h4>
                      <p class="text-4 text-color-light opacity-5 font-weight-light mb-0">Mon - Sun / 9:00AM -
                        8:00PM</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-6 ps-lg-5">
            <span
              class="d-block text-color-grey positive-ls-2 font-weight-normal custom-font-size-2 text-color-light opacity-6 text-center mb-1">CONTACT
              FORM</span>
                  ...
                  <div class="row">
                    <div class="form-group col">
                      <textarea maxlength="5000" data-msg-required="Please enter your message." rows="6"
                        class="form-control" name="message" placeholder="Your Message" required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col text-center">
                      <input type="submit" value="Send Message"
                        class="btn btn-gradient text-3 font-weight-bold px-5 py-3" data-loading-text="Loading...">
                    </div>
                  </div>
                </form>
