...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        init: function () {
            var _this = this,
                meter = jQuery('<div/>', { class: 'passtrengthMeter form-floating' }),
        ...
        addStatus: function (percentage) {
            var status = '',
                ...
                meter = $(this.element).closest('.passtrengthMeter form-floating'),
                tooltip = meter.find('.tooltip');

            meter.attr('class', 'passtrengthMeter form-floating');
        ...
        togglePassword: function () {
            ...
            buttonShow.appendTo($(this.element).closest('.passtrengthMeter form-floating'));
            input.appendTo($(this.element).closest('.passtrengthMeter form-floating')).hide();
